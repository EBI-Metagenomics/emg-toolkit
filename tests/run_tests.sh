...
cat bulk_download/MGYS00002478/MGYS00002478_metadata.tsv
md5sum bulk_download/MGYS00002478/MGYS00002478_metadata.tsv

md5sum -c bulk_download/ERR169332.5_8S_rRNA.RF00002.fa.md5
md5sum -c bulk_download/MGYS00002478_metadata.tsv.md5
rm -r MGYS00002478

# DISABLED as Sequence Search is down ATM
